...
public class FeignClientConfiguration {
	...
	@Value("${security.oauth2.client.subscription.token-uri}")
	private String accessTokenUri;

	@Value("${security.oauth2.client.subscription.clientId}")
	private String clientId;

	@Value("${security.oauth2.client.subscription.clientSecret}")
